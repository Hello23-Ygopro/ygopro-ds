...
COLOR_COLORLESS		=0xff		--Include any 5 colors
--Color combinations
...
REASON_AWAKEN		=0x2000		--Moved cards with [Awaken] (required for "P-017 Chilling Terror Android 17")
...
RESET_DROP			=0x00080000			--Reset when put into the drop area
RESET_TEMP_REMOVE	=0x00100000			--(unused)
RESET_TOHAND		=0x00200000			--(unused)
RESET_TODECK		=0x00400000			--(unused)
RESET_LEAVE			=0x00800000			--Reset when left the Battle Area
...
EFFECT_CHANGE_ENERGY_COST			=131	--Set total energy cost

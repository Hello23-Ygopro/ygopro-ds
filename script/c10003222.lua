--TB1-063 Vikal, Master of the Sky
local scard,sid=aux.GetID()
function scard.initial_effect(c)
	aux.AddCharacter(c,CHARACTER_VIKAL)
...
scard.combo_cost=0
--draw, gain skill
scard.con1=aux.AND(aux.SelfLeaderCondition(Card.IsSpecialTrait,TRAIT_UNIVERSE_2),aux.LifeEqualBelowCondition(PLAYER_SELF,5))

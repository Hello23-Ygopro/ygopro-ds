--TB1-044 Sorrel, The Small Warrior
local scard,sid=aux.GetID()
function scard.initial_effect(c)
	aux.AddCharacter(c,CHARACTER_SORREL)
...
scard.combo_cost=0
--draw, gain skill
scard.con1=aux.AND(aux.SelfLeaderCondition(Card.IsSpecialTrait,TRAIT_UNIVERSE_9),aux.LifeEqualBelowCondition(PLAYER_SELF,5))
